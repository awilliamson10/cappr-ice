"""
From https://github.com/shish/sqliteshelf (MIT License)
...
class SQLiteDict(DictMixin):
    def __init__(
        self, filename=":memory:", table="shelf", flags="r", mode=None, valtype=valtype
    ):
        self.table = table
        self.valtype = valtype
        MAKE_SHELF = (
            "CREATE TABLE IF NOT EXISTS " + self.table + " (key TEXT, value BLOB)"
        )
        MAKE_INDEX = (
